...
static int vioc_config_sc_wdma_sel[] = {
	0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, -1, -1, -1, -1, 0x20,
};

#if defined(CONFIG_TCC897X)
static int vioc_config_viqe_rdma_sel[] = {
	0x00, 0x01, 0x02, 0x03, -1, -1, -1, 0x5, -1,
	-1, -1, -1, 0x08, -1, 0x9, -1,  0x0B,
};

#elif defined(CONFIG_TCC803X)
static int vioc_config_viqe_rdma_sel[] = {
	-1, -1, -1, 0x03, -1, -1, -1, 0x05, -1,
	-1, -1, 0x07, 0x08, -1, 0x09, -1,  0x0B, 0x0D,
};

#elif defined(CONFIG_TCC805X)
static int vioc_config_viqe_rdma_sel[] = {
	-1, -1, -1, 0x03, -1, -1, -1, 0x5, -1,
	-1, 0x06, 0x07, 0x08, 0x0E, 0x9, 0x0F, 0x0B, 0x0D,
};
...
static void __iomem *CalcAddressViocComponent(unsigned int component)
{
	...
	|| defined(CONFIG_TCC901X)
		...
		case 2:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_RDMA02_OFFSET);
			break;
		case 3:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_RDMA03_OFFSET);
			break;
		case 6:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_RDMA06_OFFSET);
			break;
		case 7:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_RDMA07_OFFSET);
			break;
#if defined(CONFIG_TCC899X) || defined(CONFIG_TCC901X)
		case 10:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_RDMA10_OFFSET);
			break;
#endif
		case 11:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_RDMA11_OFFSET);
			break;
		case 12:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_RDMA12_OFFSET);
			break;
		case 13:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_RDMA13_OFFSET);
			break;
		case 14:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_RDMA14_OFFSET);
			break;
		case 16:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_RDMA16_OFFSET);
			break;
		case 17:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_RDMA17_OFFSET);
			break;
	...
	case get_vioc_type(VIOC_SCALER):
		switch (get_vioc_index(component)) {
		case 0:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_SC0_OFFSET);
			break;
		case 1:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_SC1_OFFSET);
			break;
		case 2:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_SC2_OFFSET);
			break;
		case 3:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_SC3_OFFSET);
			break;
#if !defined(CONFIG_TCC897X)
		case 4:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_SC4_OFFSET);
			break;
#endif
#if defined(CONFIG_TCC899X) || defined(CONFIG_TCC803X) \
	|| defined(CONFIG_TCC901X) || defined(CONFIG_TCC805X)
		case 5:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_SC5_OFFSET);
			break;
#endif
#if defined(CONFIG_TCC803X) || defined(CONFIG_TCC805X)
		case 6:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_SC6_OFFSET);
			break;
		case 7:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_SC7_OFFSET);
			break;
#endif
		default:
			reg = NULL;
	...
	case get_vioc_type(VIOC_VIQE):
		switch (get_vioc_index(component)) {
		case 0:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_VIQE0_OFFSET);
			break;
#if !(defined(CONFIG_TCC897X))
		case 1:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_VIQE1_OFFSET);
			break;
#endif
		default:
			reg = NULL;
	...
	case get_vioc_type(VIOC_DEINTLS):
		switch (get_vioc_index(component)) {
		case 0:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_DEINTLS_OFFSET);
			break;
		default:
			reg = NULL;
			break;
	...
	|| defined(CONFIG_TCC901X)
		case 0:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_MC0_OFFSET);
			break;
		case 1:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_MC1_OFFSET);
			break;
#endif
		default:
			reg = NULL;
	...
	case get_vioc_type(VIOC_DTRC):
		switch (get_vioc_index(component)) {
		case 0:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_DTRC0_OFFSET);
			break;
		case 1:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_DTRC1_OFFSET);
			break;
		default:
			reg = NULL;
			break;
	...
	case get_vioc_type(VIOC_SAR):
		switch (get_vioc_index(component)) {
		case 0:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_SAR0_OFFSET);
			break;
		case 1:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_SAR1_OFFSET);
			break;
		default:
			reg = NULL;
			break;
	...
	case get_vioc_type(VIOC_PIXELMAP):
		switch (get_vioc_index(component)) {
		case 0:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_PM0_OFFSET);
			break;
		case 1:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_PM1_OFFSET);
			break;
		default:
			reg = NULL;
			break;
	...
	case get_vioc_type(VIOC_F2D):
		switch (get_vioc_index(component)) {
		case 0:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_F2D0_OFFSET);
			break;
		case 1:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_F2D1_OFFSET);
			break;
		default:
			reg = NULL;
			break;
	...
	case get_vioc_type(VIOC_CINTPL):
		switch (get_vioc_index(component)) {
		case 0:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_CIN0_OFFSET);
			break;
		case 1:
			reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_CIN1_OFFSET);
			break;
		default:
			reg = NULL;
			break;
...
int VIOC_AUTOPWR_Enalbe(unsigned int component, unsigned int onoff)
{
	...
	if (onoff != 0U) {
		value =
			(__raw_readl(VIOC_IREQConfig_GetAddress() + PWR_AUTOPD_OFFSET)
		...
		__raw_writel(value, VIOC_IREQConfig_GetAddress() + PWR_AUTOPD_OFFSET);
	}
	ret = 0;
...
int VIOC_CONFIG_ResetAll(void)
{
	...
	__raw_writel(0xFFFFFFFF, VIOC_IREQConfig_GetAddress() + PWR_BLK_SWR0_OFFSET);
#endif
#if defined(PWR_BLK_SWR1_OFFSET)
	__raw_writel(0xFFFFFFFF, VIOC_IREQConfig_GetAddress() + PWR_BLK_SWR1_OFFSET);
#endif
#if defined(PWR_BLK_SWR2_OFFSET)
	__raw_writel(0xFFFFFFFF, VIOC_IREQConfig_GetAddress() + PWR_BLK_SWR2_OFFSET);
#endif
#if defined(PWR_BLK_SWR3_OFFSET)
	__raw_writel(0xFFFFFFFF, VIOC_IREQConfig_GetAddress() + PWR_BLK_SWR3_OFFSET);
#endif
#if defined(PWR_BLK_SWR4_OFFSET)
	__raw_writel(0xFFFFFFFF, VIOC_IREQConfig_GetAddress() + PWR_BLK_SWR4_OFFSET);
#endif

/* resume */
#if defined(PWR_BLK_SWR4_OFFSET)
	__raw_writel(0x00000000, VIOC_IREQConfig_GetAddress() + PWR_BLK_SWR4_OFFSET);
#endif
#if defined(PWR_BLK_SWR3_OFFSET)
	__raw_writel(0x00000000, VIOC_IREQConfig_GetAddress() + PWR_BLK_SWR3_OFFSET);
#endif
#if defined(PWR_BLK_SWR2_OFFSET)
	__raw_writel(0x00000000, VIOC_IREQConfig_GetAddress() + PWR_BLK_SWR2_OFFSET);
#endif
#if defined(PWR_BLK_SWR1_OFFSET)
	__raw_writel(0x00000000, VIOC_IREQConfig_GetAddress() + PWR_BLK_SWR1_OFFSET);
#endif
#if defined(PWR_BLK_SWR0_OFFSET)
	__raw_writel(0x00000000, VIOC_IREQConfig_GetAddress() + PWR_BLK_SWR0_OFFSET);
#endif
	return 0;
}
...
int VIOC_CONFIG_WMIXPath(unsigned int component_num, unsigned int mode)
{
	...
	void __iomem *config_reg = VIOC_IREQConfig_GetAddress();
	int ret = -1;
...
int VIOC_CONFIG_MCPath(unsigned int component, unsigned int mc)
{
	int ret = 0;
	u32 value;
	void __iomem *reg = (VIOC_IREQConfig_GetAddress() + CFG_PATH_MC_OFFSET);
...
{
	return (void __iomem *)HwVIOC_CONFIG;
}
...
void VIOC_CONFIG_RDMA12PathCtrl(unsigned int Path)
{
	...
	void __iomem *reg = (void __iomem *)VIOC_IREQConfig_GetAddress() + CFG_MISC0_OFFSET;
	u32 value;
...
void VIOC_CONFIG_SetLoopBack(unsigned int vin, unsigned int path)
{
	...
	void __iomem *reg = (void __iomem *)VIOC_IREQConfig_GetAddress() + TEST_LOOP_OFFSET;
	u32 value;
	value =
		(__raw_readl(reg)
