...
#else
static void __iomem *pIREQ_reg = (void __iomem *)(HwVIOC_BASE + 0xB0000);
...
static void __iomem *CalcAddressViocComponent(unsigned int component)
{
	...
	case get_vioc_type(VIOC_SCALER):
		...
		case 3:
			...
			break;
#if !(defined(CONFIG_TCC897X) || defined(CONFIG_TCC750X))
		case 4:
...
#if defined(CONFIG_TCC805X) || defined(CONFIG_TCC750X)
