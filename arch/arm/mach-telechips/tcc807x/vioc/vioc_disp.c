...
void VIOC_DISP_SetColorEnhancement(void __iomem *reg, unsigned int contrast,
...
void VIOC_DISP_GetColorEnhancement(const void __iomem *reg, unsigned int *contrast,
	unsigned int *brightness, unsigned int *hue)
{
    /*
