...
void vioc_intr_initialize(void)
{
	...
	for (i = 0; i <= ((unsigned int)VIOC_INTR_DEV4 - (unsigned int)VIOC_INTR_DEV0); i++) {
	...
	for (i = 0; i <= ((unsigned int)VIOC_INTR_RD15 - (unsigned int)VIOC_INTR_RD0); i++) {
	...
	for (i = 0; i <= ((unsigned int)VIOC_INTR_WD5 - (unsigned int)VIOC_INTR_WD0); i++) {
