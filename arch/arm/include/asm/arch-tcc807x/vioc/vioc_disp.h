...
#define DCTRL_FLDINV_SHIFT (27U) // Advanced interlaced mode
...
#define DSTATUS_TFIELD_SHIFT (29U) // Top Field
#define DSTATUS_DEOF_SHIFT (28U)   // Device EOF
...
/*
 * Display Controller Underrun Balue Register
 */
#define DUDR_VAL_DM_SHIFT (31U)
#define DUDR_VAL_VALUE_SHIFT (0U)

#define DUDR_VAL_DM_MASK ((u32)0x1U << DUDR_VAL_DM_SHIFT)
#define DUDR_VAL_VALUE_MASK ((u32)0xFFFFFFU << DUDR_VAL_VALUE_SHIFT)

/*
 * Display Device Align Register
 */
#define DALIGN_SWAPAF_SHIFT (3U)
#define DALIGN_SWAPBF_SHIFT (0U)
...
extern void VIOC_DISP_GetPosition(
	void __iomem *reg, unsigned int *startX, unsigned int *startY);
extern void VIOC_DISP_SetColorEnhancement(void __iomem *reg, unsigned int contrast,
	unsigned int brightness, unsigned int hue);
extern void VIOC_DISP_GetColorEnhancement(const void __iomem *reg, unsigned int *contrast,
	unsigned int *brightness, unsigned int *hue);
