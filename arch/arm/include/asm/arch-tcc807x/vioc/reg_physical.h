...
/******************************************************************
 *
 *	TCC807X DataSheet PART 7 DISPLAY BUS
 *
 ******************************************************************/
...
#define HwVIOC_DISP1 (HwVIOC_BASE + 0x01000UL)
#define HwVIOC_DISP2 (HwVIOC_BASE + 0x02000UL)
#define HwVIOC_DISP3 (HwVIOC_BASE + 0x03000UL)
#define HwVIOC_DISP4 (HwVIOC_BASE + 0x04000UL)
...
#define HwVIOC_RDMA16 (HwVIOC_BASE + 0x30000UL)
#define HwVIOC_RDMA17 (HwVIOC_BASE + 0x31000UL)
...
#define HwVIOC_WMIX4 (HwVIOC_BASE + 0x64000UL)
...
#define HwVIOC_SC4 (HwVIOC_BASE + 0x54000UL)
#define HwVIOC_SC5 (HwVIOC_BASE + 0x55000UL)
#define HwVIOC_SC6 (HwVIOC_BASE + 0x56000UL)
#define HwVIOC_SC7 (HwVIOC_BASE + 0x57000UL)
...
#define HwVIOC_WDMA06 (HwVIOC_BASE + 0x46000UL)
#define HwVIOC_WDMA07 (HwVIOC_BASE + 0x47000UL)
#define HwVIOC_WDMA08 (HwVIOC_BASE + 0x48000UL)
#define TCC_VIOC_WDMA_BASE(x) (HwVIOC_WDMA00 + (WDMA_OFFSET * (x)))

/* MC */
#define MC_OFFSET (0x1000UL)
#define HwVIOC_MC0 (HwVIOC_BASE + 0x90000UL)
#define HwVIOC_MC1 (HwVIOC_BASE + 0x91000UL)
...
#define HwVIOC_3D_LUT0_1 (HwVIOC_BASE + 0x08000UL)
#define TCC_VIOC_3D_LUT0_BASE(x) (HwVIOC_3D_LUT0_1 + (LUT_3D_LUT0_OFFSET * (x)))
