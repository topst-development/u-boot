 ...
 */
#define VIN_MON_CLR_SHIFT			(0U)

#define VIN_MON_CLR_MASK			((u32)0x1U << VIN_MON_CLR_SHIFT)
...
/*
 * VIN Monitor for DataEn Register
 */
...
/*
 * VIN Monitor for Line Counter Register
 */
 ...
 */
#define VIN_MON_VSCNT_SHIFT		(0U)

#define VIN_MON_VSCNT_MASK ((u32)0xFFFFFFFFU << VIN_MON_VSCNT_SHIFT)

/*
 * VIN Monitor for Vertical Sync MAX Register
 */
#define VIN_MON_VSMAX_SHIFT		(0U)

#define VIN_MON_VSMAX_MASK ((u32)0xFFFFFFFFU << VIN_MON_VSMAX_SHIFT)
