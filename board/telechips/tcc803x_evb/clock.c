...
#define VPLL_DIV(div0, div1)  ((unsigned long)((unsigned long)(div1) << \
			8UL) | (unsigned long)(div0))

static uint32_t __iomem *TCC_TIMER_BASE = (uint32_t __iomem *)0x14300000U;
...
void clock_init_early(void)
{
	...
	writel((0x5B), (&TCC_TIMER_BASE[2]));    /* Timer0 TCNT reg. write */
