...
#include <efi_loader.h>
#endif
#if defined(CONFIG_TCC_SECUREBOOT)
...
#elif defined(CONFIG_TCC_UFS_BOOT) && !defined(CONFIG_ENV_IS_IN_SCSI)
static int initr_scsi(void)
{
	scsi_scan(true);
	return 0;
...
#if defined(CONFIG_TCC_SECUREBOOT)
static int initr_secureboot(void)
{
	tc_secureboot_init();
	return 0;
}
...
static init_fnc_t init_sequence_r[] = {
	...
	initr_scsi,
#endif
#if defined(CONFIG_TCC_UFS_BOOT) && !defined(CONFIG_ENV_IS_IN_SCSI)
	initr_scsi,
#endif
#if defined(CONFIG_TCC_SECUREBOOT)
	initr_secureboot,
