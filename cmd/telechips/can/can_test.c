...
#if defined(CONFIG_TCC807X)
#define DMA_ADDR (0x18330000)
#else
#define DMA_ADDR (0x16060000)
#endif
...
static int32_t CANTEST_DMATestWithMessages(uint8_t ucCh, uint32_t * puiAddr)
{
	...
	DMA_WR((DMA_ADDR + DMA_CONF), 0x1);
	DMA_WR((DMA_ADDR + DMA_SRC), 0x42000000);
	DMA_WR((DMA_ADDR + DMA_DST), 0x42001000);
	DMA_WR((DMA_ADDR + DMA_CONT), 0xC000004);
	DMA_WR((DMA_ADDR + DMA_CH), 0x3001);
	DMA_WR(0x42000100, 0x33323130);
