...
#define LVDS_DUAL_SPLIT_ODD_EVEN 0
#define LVDS_DUAL_SPLIT_LEFT_RIGHT 1

/* define for LVDS */

/* define for DP V1.4 --------------------------------------------*/
#define CUSTOM_VIC_1027 	1027
#define CUSTOM_VIC_1028		1028
...
#define NO_COMPONENT_SDM_TRVC	0xFF
#define SDM_BYPASS_DISABLE 	0
#define SDM_BYPASS_ENABLE 	1
#define TRVC_BYPASS_DISABLE 	0
#define TRVC_BYPASS_ENABLE 	1

#define SDM_SVSC_DISABLE 	0
#define SDM_SVSC_ENABLE 	1
#define TRVC_SVSC_DISABLE 	0
#define TRVC_SVSC_ENABLE 	1

#define PANEL_MODE_OFF 		0U
#define PANEL_MODE_ON 		1U
...
#define VIDEO_FORMAT_CEA_861	0
#define VIDEO_FORMAT_VESA_CVT	1
#define VIDEO_FORMAT_VESA_DMT	2
