...
#ifndef __DT_BINDINGS_TCC803X_VIOC_H
#define __DT_BINDINGS_TCC803X_VIOC_H
...
#define VIOC_IMG_FMT_RGB888 \
	(14) // 3bytes	: newly supported : 3 bytes format
#define VIOC_IMG_FMT_ARGB6666_3 \
	(15) // 3bytes	: newly supported : 3 bytes format
#define VIOC_IMG_FMT_COMP (16) // 4bytes
#define VIOC_IMG_FMT_DECOMP (VIOC_IMG_FMT_COMP)
#define VIOC_IMG_FMT_444SEP (21) // 3bytes
#define VIOC_IMG_FMT_UYVY \
	(22) // 2bytes	: LSB [Y/U/Y/V] MSB : newly supported : 2 bytes format
#define VIOC_IMG_FMT_VYUY \
	(23) // 2bytes	: LSB [Y/V/Y/U] MSB : newly supported : 2 bytes format
#define VIOC_IMG_FMT_YUV420SEP (24) // 1,1byte
#define VIOC_IMG_FMT_YUV422SEP (25) // 1,1byte
#define VIOC_IMG_FMT_YUYV \
	(26) // 2bytes	: LSB [Y/U/Y/V] MSB : previous SEQ
#define VIOC_IMG_FMT_YVYU \
	(27) // 2bytes	: LSB [Y/V/Y/U] MSB : newly supported : 2 bytes format
...
#endif /* __DT_BINDINGS_TCC803X_VIOC_H */
