...
// 0   - 4K	For bootloader_message
// 4K  - 16K	Used by Vendor's bootloader (the 2K - 4K range may be optionally
...
static const size_t BOOTLOADER_MESSAGE_OFFSET_IN_MISC;
static const size_t WIPE_PACKAGE_OFFSET_IN_MISC = 16 * 1024;

/* Bootloader Message (4-KiB)
 *
...
static_assert(sizeof(struct bootloader_message) == 4096,
	      "struct bootloader_message size changes, which may break A/B devices");
#endif
#endif /* __UBOOT__ */

/**
 * The A/B-specific bootloader message structure (8-KiB).
 *
...
#ifndef __UBOOT__
#if (__STDC_VERSION__ >= 201112L) || defined(__cplusplus)
static_assert(sizeof(struct bootloader_message_ab) == 8192,
