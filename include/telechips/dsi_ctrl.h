...
#define CAM_CFG_REG		0x1C004000U
#define	MIPI_DSI_CH_SEL_OFFSET	0x1C004010U

#define	S0_MUX_SEL_SHIFT	0
#define	S1_MUX_SEL_SHIFT	3

#define	TRVC_DIS_SHIFT	8U
#define	SDM_DIS_SHIFT	9U
...
#define MIPI_PHY_M_RESETN 	2U
#define MIPI_PHY_S_RESETN 	3U


#define DSI_CORE_ADDR	0x16010000

#define CAM_CFG_ADDR	0x16004000
#define MIPI_DSI_CTRL   0x16004050U
