		...
		struct scsi_cmd *pccb)
{
	...
	if((scsi_dev == NULL) || (pccb == NULL) || (handle == NULL)) {
		ret= -ENODEV;
	} else {
		host = scsi_dev->priv_;
		/*
...
static int32_t tcc_sc_ufs_query(const struct udevice *scsi_dev,
