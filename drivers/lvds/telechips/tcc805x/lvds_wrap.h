...
#define TS_MUX_EN3 (0x194u)
#define TS_MUX_SEL3 (0x198u)
...
#define SM_BYPASS (0x214u) /* TCC805X CS only */
...
#define TS_CFG_WIDTH_MASK (0xFFFUL << TS_CFG_WIDTH_SHIFT)
#define TS_CFG_SWAP3_MASK (0x3UL << TS_CFG_SWAP3_SHIFT)
#define TS_CFG_SWAP2_MASK (0x3UL << TS_CFG_SWAP2_SHIFT)
#define TS_CFG_SWAP1_MASK (0x3UL << TS_CFG_SWAP1_SHIFT)
#define TS_CFG_SWAP0_MASK (0x3UL << TS_CFG_SWAP0_SHIFT)
#define TS_CFG_MODE_MASK (0x1UL << TS_CFG_MODE_SHIFT)
#define TS_CFG_LR_MASK (0x1UL << TS_CFG_LR_SHIFT)
#define TS_CFG_BP_MASK (0x1UL << TS_CFG_BP_SHIFT)

/*
 * DISP MUX Enable Register
 */
#define DISP_MUX_EN_EN_SHIFT (0)
#define DISP_MUX_EN_EN_MASK (0x1UL << DISP_MUX_EN_EN_SHIFT)

/*
 * DISP MUX Select Register
 */
#define DISP_MUX_SEL_SEL_SHIFT (0)
#define DISP_MUX_SEL_SEL_MASK (0x3UL << DISP_MUX_SEL_SEL_SHIFT)

/*
 * Tx splitter MUX Enable Register
 */
#define TS_MUX_EN_EN_SHIFT (0)
#define TS_MUX_EN_EN_MASK (0x1UL << TS_MUX_EN_EN_SHIFT)

/*
 * Tx splitter MUX Select Register
 */
#define TS_MUX_SEL_SEL_SHIFT (0)
#define TS_MUX_SEL_SEL_MASK (0x7UL << TS_MUX_SEL_SEL_SHIFT)
...
#define SAL_DE_MASK (0x1UL << SAL_DE_SHIFT)
#define SAL_HS_MASK (0x1UL << SAL_HS_SHIFT)
#define SAL_VS_MASK (0x1UL << SAL_VS_SHIFT)

/*
 * Clock checker reference clock count
 */
#define REF_CLK_CNT_SHIFT (0)
#define REF_CLK_CNT_MASK (0xFFF << REF_CLK_CNT_SHIFT)

/*
 * Clock checker compare clock count
 */
#define CMP_CLK_CNT_MIN_SHIFT (16)
#define CMP_CLK_CNT_MAX_SHIFT (0)

#define CMP_CLK_CNT_MIN_MASK (0xFFF << CMP_CLK_CNT_MIN_SHIFT)
#define CMP_CLK_CNT_MAX_MASK (0xFFF << CMP_CLK_CNT_MAX_SHIFT)
...
#define HSYNC_CFG_2_HACTIVEM_MASK (0xF << HSYNC_CFG_2_HACTIVEM_SHIFT)
#define HSYNC_CFG_2_HBPM_MASK (0xF << HSYNC_CFG_2_HBPM_SHIFT)
#define HSYNC_CFG_2_HSYNCM_MASK (0xF << HSYNC_CFG_2_HSYNCM_SHIFT)
#define HSYNC_CFG_2_HFPM_MASK (0xF << HSYNC_CFG_2_HFPM_SHIFT)
...
#define VSYNC_CFG_2_VACTIVEM_MASK (0xF << VSYNC_CFG_2_VACTIVEM_SHIFT)
 ...
 */
#define SWRESET_SAFETY_BLOCK_SHIFT (5)
#define SWRESET_LVDS_PHY_2PORT_SYS_SHIFT (4)
#define SWRESET_LVDS_PHY_1PORT_SYS_SHIFT (3)
#define SWRESET_LVDS_PHY_2PORT_APB_SHIFT (2)
#define SWRESET_LVDS_PHY_1PORT_APB_SHIFT (1)
#define SWRESET_TS_SHIFT (0)

#define SWRESET_SAFETY_BLOCK_MASK \
	(0x1 << SWRESET_SAFETY_BLOCK_SHIFT)
#define SWRESET_LVDS_PHY_2PORT_SYS_MASK \
	(0x1 << SWRESET_LVDS_PHY_2PORT_SYS_SHIFT)
#define SWRESET_LVDS_PHY_1PORT_SYS_MASK \
	(0x1 << SWRESET_LVDS_PHY_1PORT_SYS_SHIFT)
#define SWRESET_LVDS_PHY_2PORT_APB_MASK \
	(0x1 << SWRESET_LVDS_PHY_2PORT_APB_SHIFT)
#define SWRESET_LVDS_PHY_1PORT_APB_MASK \
	(0x1 << SWRESET_LVDS_PHY_1PORT_APB_SHIFT)
...
extern void LVDS_WRAP_SetDataArray(
	uint32_t ch,
	uint32_t data[TXOUT_MAX_LINE][TXOUT_DATA_PER_LINE]);
extern void LVDS_WRAP_SetConfigure(
	uint32_t lr, uint32_t bypass, uint32_t width);
extern void LVDS_WRAP_SetDataSwap(uint32_t ch, uint32_t set);
extern void LVDS_WRAP_SetMuxOutput(
	uint32_t mux, uint32_t ch, uint32_t select, uint32_t enable);
extern void LVDS_WRAP_GetMuxOutput(
	uint32_t mux, uint32_t ch, uint32_t *select, uint32_t *enable);
extern void LVDS_WRAP_SetAccessCode(void);
extern void LVDS_WRAP_ResetPHY(uint32_t port, uint32_t reset);
extern void LVDS_WRAP_SetSyncPolarity(uint32_t sync_);
