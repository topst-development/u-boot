...
static struct SNPY_CFG_Reg_Data stSNPY_CFG_Reg_Data[] = {
	...
	{(uint8_t)LINK_RATE_RBR,  DP_REGISTER_BANK_REG_16, REG_BANK_REG_16_RBR_INIT},
	...
	{(uint8_t)LINK_RATE_RBR,  DP_REGISTER_BANK_REG_15, REG_BANK_REG_15_RBR_INIT},
	...
	{(uint8_t)LINK_RATE_HBR3, DP_REGISTER_BANK_REG_16, REG_BANK_REG_16_HBR3_INIT},


	{(uint8_t)LINK_RATE_HBR,  DP_REGISTER_BANK_REG_16, REG_BANK_REG_16_HBR_INIT},
	{(uint8_t)LINK_RATE_HBR2, DP_REGISTER_BANK_REG_16, REG_BANK_REG_16_HBR2_INIT},
	{(uint8_t)LINK_RATE_HBR3, DP_REGISTER_BANK_REG_15, REG_BANK_REG_15_HBR3_INIT},

	{(uint8_t)LINK_RATE_HBR,  DP_REGISTER_BANK_REG_15, REG_BANK_REG_15_HBR_INIT},
	{(uint8_t)LINK_RATE_HBR2, DP_REGISTER_BANK_REG_15, REG_BANK_REG_15_HBR2_INIT},
...
int32_t Dptx_Cfg_Reset(struct Dptx_Params *pstDptx, uint8_t ucLinkRate)
{
	...
	if (pstDptx->ePhy_Dev == PHY_DEVICE_SEC) {
		...
		dptx_debug("Reset for Samsung PHY");
