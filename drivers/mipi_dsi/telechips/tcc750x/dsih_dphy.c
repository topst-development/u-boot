...
{
	__raw_writel(data, (uintptr_t)(dev->cfg_addr + reg_address));
}
...
{
	return __raw_readl((uintptr_t)(dev->cfg_addr + reg_address));
}
/**
...
{
	return __raw_readl((uintptr_t)(dev->core_addr + reg_address));
}
/**
 * 
 * Write bit field to D-PHY module (encapsulating the bus interface)
